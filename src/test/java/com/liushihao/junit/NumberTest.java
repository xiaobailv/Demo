...
//        Integer j = 5;
    ...
    public void integerParse() {
        ...
        System.out.println("aDouble = " + aDouble.intValue());
...
//        System.out.println(new BigDecimal(""));
    ...
    @Test
    public void longMax() {
        String fileName = "C:/Users/11092/Downloads/WormholeInstaller.exe";
        File file = new File(fileName);
        long length = file.length();
        long max = 5 * 1024 *1024L;
        System.out.println("length = " + length);
        System.out.println("max = " + max);
        if (length > max) {
            System.out.println("上传文件不能超过5M");
        } else {
